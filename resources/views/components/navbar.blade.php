<nav id="Navbar" class="max-w-[1130px] mx-auto flex justify-between items-center mt-[30px]">
		<div class="logo-container flex gap-[30px] items-center">
			<a href="{{route('front.index')}}" class="flex shrink-0">
				<img src="{{asset('assets//images/logos/lyfe.svg')}}" alt="logo" />
			</a>
			...
			<form method="GET" action="{{route('front.search')}}"
				...
				<input type="text" name="keyword" id=""
					...
					placeholder="Cari apa yang trending saat ini..." />
			</form>
		</div>
		<div class="flex items-center gap-3">
			<a href=""
				class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#FF6B18]">Langganan
				Pro</a>
			<a href=""
